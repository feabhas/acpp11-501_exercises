...
static volatile std::uint32_t       *const GPIOD_moder {reinterpret_cast<std::uint32_t*>(GPIOD_BASE)};
static volatile std::uint32_t       *const GPIOD_outr  {reinterpret_cast<std::uint32_t*>(GPIOD_BASE + 0x14u)};
static volatile std::uint32_t const *const GPIOD_inr   {reinterpret_cast<std::uint32_t*>(GPIOD_BASE + 0x10u)};
...
int main()
{
    ...
    std::uint32_t moder = *GPIOD_moder;
